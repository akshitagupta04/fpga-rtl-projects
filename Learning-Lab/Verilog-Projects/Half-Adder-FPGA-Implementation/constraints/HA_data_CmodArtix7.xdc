...
## LEDs as outputs
set_property -dict { PACKAGE_PIN A17   IOSTANDARD LVCMOS33 } [get_ports {sum}]; #IO_L12N_T1_MRCC_16 Sch=sum
set_property -dict { PACKAGE_PIN C16   IOSTANDARD LVCMOS33 } [get_ports {carry}]; #IO_L13P_T2_MRCC_16 Sch=carry
