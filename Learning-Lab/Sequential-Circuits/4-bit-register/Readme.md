...
- In the second method, I reprogrammed it through module instantiation using four 2x1 Multiplexers and four D flip-flops.
...
> 4-bit register using Flip-flops and Multiplexers is here: Diagram is here ![4-bit register using FF UX](./assets/4-bit-register-using-FF-MUX.jpg)
